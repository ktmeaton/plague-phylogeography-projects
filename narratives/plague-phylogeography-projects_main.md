...
For the purposes of this narrative, the sub-clade nomenclature will not be used. But if you're interested, you can view the [dataset colored by sub-clades here](https://nextstrain.org/community/ktmeaton/plague-phylogeography-projects@main/main/full/all?c=branch_minor&d=tree&legend=open&m=div&p=full).
